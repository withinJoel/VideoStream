...
const extractCategories = (filename) => {
    ...
    'shower': ['shower', 'bathroom', 'wet', 'bath', 'bathing'],
    ...
    'facefuck': ['facefuck', 'face-fuck', 'mouth-fuck'],
    'celebrity': ['celebrity', 'famous', 'hollywood', 'star'],
    'drunk': ['drunk', 'alcohol', 'wasted', 'intoxicated'],
    'gloryhole': ['gloryhole', 'glory-hole', 'hole-play'],
    'bdsm': ['bdsm', 'bondage', 'submissive', 'dominant'],
    'outfit': ['outfit', 'dressup', 'lingerie', 'stockings', 'costume'],
    'fingering': ['fingering', 'digit', 'insert-finger', 'fingered'],
    'spycam': ['spycam', 'hidden-cam', 'voyeur', 'cam-secret'],
    'twerk': ['twerk', 'twerking', 'booty-shake', 'ass-dance'],
    'dirty-talk': ['dirty-talk', 'talking-dirty', 'naughty-talk', 'voice'],
    'uncensored': ['uncensored', 'raw', 'no-blur', 'no-censor'],
    'caught': ['caught', 'spy', 'watching', 'secret'],
    'oil': ['oil', 'oiled', 'slippery', 'massage-oil'],
    'indian': ['indian', 'desi', 'hindi', 'bharat'],
    'neighbor': ['neighbor', 'next-door', 'neighbour', 'girl-next-door'],
    'nude-yoga': ['nude-yoga', 'naked-yoga', 'yoga'],
    'roleplay': ['roleplay', 'acting', 'skit', 'script-play'],
    'lingerie': ['lingerie', 'bra', 'panty', 'sexy-underwear'],
    'trainer': ['trainer', 'coach', 'gym', 'fitness-instructor'],
    'cuckold': ['cuckold', 'cuck', 'watching-husband', 'hotwife'],
    'homemade' : ['homemade'],
    'Kissing' : ['kissing', 'kiss'],
    'muslim' : ['arab', 'muslim'],
    'step-family': ['stepmom', 'stepsister', 'stepbrother', 'stepdad', 'step-family'],
